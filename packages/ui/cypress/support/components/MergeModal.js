...
export function ClickSaveAsIsButton() { cy.Get('[data-testid="merge-modal-save-as-is-button"]').Click() }
export function $ClickSaveAsIsButton() { Cypress.$('[data-testid="merge-modal-save-as-is-button"]').click() }
