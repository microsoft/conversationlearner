...
describe('API Memory Manipulation - Train', () => {
  ...
  context('Train', () => {
    ...
    it('Should invoke API Callbacks to move "anchovies" from "Toppings" to "OutOfStock" memory', () => {
      ...
      memoryTableComponent.VerifyNewEntityNameAndValues('Toppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
      memoryTableComponent.VerifyNewEntityNameAndValues('OutOfStock', ['anchovies'])
    ...
    it('Should invoke API Callbacks to move contents of "Toppings" to "LastToppings" and deletes content of "Toppings" Entity', () => {
      ...
      memoryTableComponent.VerifyNewEntityNameAndValues('LastToppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
      memoryTableComponent.VerifyDeletedEntityNameAndValues('Toppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
    })
    ...
    it('Should invoke API Callbacks to move contents of "LastToppings" back into "Toppings" and deletes content of "LastToppings', () => {
      ...
      memoryTableComponent.VerifyNewEntityNameAndValues('Toppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
      memoryTableComponent.VerifyDeletedEntityNameAndValues('LastToppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
      train.SelectTextAction('You have cheese, mushrooms, peppers, sausage and olives on your pizza.')
      train.SelectTextAction('Would you like anything else?')
    })
    ...
    it('Should remove one of the toppings and verify the resulting list is correct', () => {
      ...
      memoryTableComponent.VerifyExistingEntityValues('Toppings', ['cheese', 'mushrooms', 'peppers', 'sausage', 'olives'])
      entityDetectionPanel.LabelTextAsEntity('sausage', '-Toppings')
      train.ClickScoreActionsButton()
      memoryTableComponent.VerifyExistingEntityValues('Toppings', ['cheese', 'mushrooms', 'peppers', 'olives'])
      memoryTableComponent.VerifyDeletedEntityValues('Toppings', ['sausage'])
