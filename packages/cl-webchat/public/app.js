...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    function App() {
	        ...
	        conversation$.subscribe(function (conversation) { return state$(conversation).subscribe(function (state) { return _this.setState(state); }, function (error) { return console.log("errors", error); }); }, function (error) { return console.log("error starting conversation", error); });
	    }
