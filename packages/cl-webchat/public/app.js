...
/***/ function(module, exports, __webpack_require__) {
	...
	var composeStart = { text: "", enableSend: true };
	var outgoing$ = new rxjs_1.Subject();
	var compose$ = new rxjs_1.Subject();
	...
	var state$ = function (conversation) {
	    return message$(conversation).startWith([])
	        .combineLatest(compose$.startWith(composeStart), function (messages, compose) { return ({
	...
	var App = (function (_super) {
	    ...
	    function App() {
	        ...
	        this.updateMessage = function (text) {
	            compose$.next({ text: text, enableSend: _this.state.compose.enableSend });
	        };
	        this.sendMessage = function () {
	            compose$.next({ text: _this.state.compose.text, enableSend: false });
	            directLine_1.postMessage({
	                ...
	                compose$.next({ text: _this.state.compose.text, enableSend: true });
	            });
	        };
	        this.state = {
	            conversation: null,
	        ...
	        directLine_1.startConversation().subscribe(function (conversation) { return state$(conversation).subscribe(function (state) { return _this.setState(state); }, function (error) { return console.log("errors", error); }); }, function (error) { return console.log("error starting conversation", error); });
	    }
	    App.prototype.render = function () {
	        return React.createElement("div", {id: "appFrame"}, React.createElement(Outgoing_tsx_1.Outgoing, __assign({sendMessage: this.sendMessage, updateMessage: this.updateMessage}, this.state.compose)), React.createElement(History_tsx_1.History, {messages: this.state.messages}));
	    };
	    return App;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Outgoing = function (props) {
	    return React.createElement("div", {id: "outgoingFrame"}, React.createElement("textarea", {id: "outgoing", value: props.text, onChange: function (e) { return props.updateMessage(e.target.value); }, disabled: !props.enableSend}), React.createElement("button", {id: "send", onClick: props.sendMessage, disabled: !props.text || props.text.length == 0 || !props.enableSend}, "send"));
	};
