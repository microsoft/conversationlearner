...
/***/ function(module, exports, __webpack_require__) {
	...
	var messagegroup$ = function (conversation) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.render = function () {
	        return React.createElement("div", {id: "appFrame"}, React.createElement(History_tsx_1.History, {messagegroups: this.state.messagegroups}), React.createElement(Console_tsx_1.Console, __assign({actions: this.consoleActions}, this.state.console)));
	    };
	    return App;
	}(React.Component));
