...
export enum ReplayErrorType {
  ...
  ChangeModelException = 'ChangeModelException',
...
export class ReplayErrorAPIPlaceholder extends ReplayError {
  constructor() {
    super(ReplayErrorType.APIPlaceholder, ReplayErrorLevel.WARNING)
  }
}
...
export class ReplayChangeModelException extends ReplayError {
  constructor() {
    super(ReplayErrorType.ChangeModelException, ReplayErrorLevel.ERROR)
  }
}
